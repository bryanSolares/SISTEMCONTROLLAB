...
public class TareasPendiente extends javax.swing.JPanel {
    ...
    private ListaTareasTableModel modeloTablaTareas;
    private Tarea tarea;
    ...
    private void modelarTabla() {
        ...
        this.JTBL_tareas.getColumnModel().getColumn(1).setPreferredWidth(0);
        this.JTBL_tareas.getColumnModel().getColumn(2).setPreferredWidth(500);
        this.JTBL_tareas.getColumnModel().getColumn(2).setHeaderValue("CLIENTE");
        this.JTBL_tareas.getColumnModel().getColumn(3).setPreferredWidth(500);
        this.JTBL_tareas.getColumnModel().getColumn(3).setHeaderValue("POR HACER");
        ...
        this.JTBL_tareas.getColumnModel().getColumn(7).setHeaderValue("FECHA INICIO");
    ...
    public void setDAOClientes(DAOManager manager) {
        try {
            ...
            modeloTablaTareas = new ListaTareasTableModel(manager.getDAOTareas(), manager.getDAOClientes());
